...
Promise.all([
  ...
  if (res[9] !== res[8]) {
    console.log(`[WRONG] vconsole-atzuche-env 包不是最新版本，当前版本为 ${res[9]}，请升级至 ${res[8]}`)
    console.log('        yarn add vconsole-atzuche-env -D')
  } else {
    console.log(`[OK] vconsole-atzuche-env 是最新版本`)
  }
  if (res[11] !== res[10]) {
    console.log(`[WRONG] vconsole-atzuche-webpack-plugin 包不是最新版本，当前版本为 ${res[11]}，请升级至 ${res[10]}`)
